                ...
                <ul class="user-info pull-left pull-none-xsm">
                    ...
                    <li class="profile-info dropdown">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="assets/images/member-3.jpg" alt="" class="img-circle" width="44"/>
            ...
            <header class="row">
                <div class="col-sm-2">
                    <a href="#" class="profile-picture">
                        <img src="assets/images/member-3.jpg" class="img-responsive img-circle"/>
                    </a>
                </div>
                <div class="col-sm-7">
