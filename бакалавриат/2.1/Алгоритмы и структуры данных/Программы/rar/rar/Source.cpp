...
TEST_CASE("MTF") {
	f.open("C:/Users/Pavel/Desktop/rar/encodeBWT.bzip2", ios::out | ios::binary);
	g.open("C:/Users/Pavel/Desktop/rar/decodeMTF.bzip2", ios::out | ios::binary);
	while (1) {
		char c1 = f.get();
		char c2 = g.get();
		if (f.eof())
...
TEST_CASE("BWT") {
	f.open("C:/Users/Pavel/Desktop/rar/omg.txt", ios::out | ios::binary);
	g.open("C:/Users/Pavel/Desktop/rar/decodeBWT.txt", ios::out | ios::binary);
	while (1) {
		char c1 = f.get();
		char c2 = g.get();
		if (f.eof())
