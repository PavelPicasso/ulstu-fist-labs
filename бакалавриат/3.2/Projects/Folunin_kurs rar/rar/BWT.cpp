...
void BWT::encode(string file) {
	Length = 9999;
	f.open("C:/Users/forty/Desktop/rar/" + file, ios::out | ios::binary);
	g.open("C:/Users/forty/Desktop/rar/encodeBWT.bzip2", ios::out | ios::binary);
	char ch;
	while (1) {
		FileContent.clear();
...
void BWT::decode(string extension) {
	f.open("C:/Users/forty/Desktop/rar/decodeMTF.bzip2", ios::out | ios::binary);
	g.open("C:/Users/forty/Desktop/rar/decodeBWT." + extension, ios::out | ios::binary);
	char ch;
	int size = 9999;
	while (1) {
		if (f.eof()) {
