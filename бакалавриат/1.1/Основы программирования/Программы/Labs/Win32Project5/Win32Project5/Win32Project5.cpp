...
void Zv4(HDC hdc, int x, int y, int rad, int depth);
void Zv5(HDC hdc, int x, int y, int rad, int depth);
...
void Zv5(HDC hdc, int x, int y, int rad, int depth) {
	if (depth <= 0)
		return;
	MoveToEx(hdc, x, y - rad, NULL);
	LineTo(hdc, x + rad / 4, y - rad / 4);
	LineTo(hdc, x + rad, y - rad / 4);
	LineTo(hdc, x + rad / 3, y + rad / 4);
	LineTo(hdc, x + rad / 2, y + rad);
	LineTo(hdc, x, y + rad / 4);
	LineTo(hdc, x - rad / 2, y + rad);
	LineTo(hdc, x - rad / 3, y + rad / 4);
	LineTo(hdc, x - rad, y - rad / 4);
	LineTo(hdc, x - rad / 4, y - rad / 4);
	LineTo(hdc, x, y - rad);
	Zv4(hdc, x, y - rad, rad / 2, depth - 1);
	Zv4(hdc, x + rad, y - rad / 4, rad / 2, depth - 1);
	Zv4(hdc, x + rad / 2, y + rad, rad / 2, depth - 1);
	Zv4(hdc, x - rad / 2, y + rad, rad / 2, depth - 1);
	Zv4(hdc, x - rad, y - rad / 4, rad / 2, depth - 1);
}
