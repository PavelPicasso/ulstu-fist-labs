...
<HTML>
<HEAD>
<TITLE>Ввод нового направления</TITLE>
...
<form method="post" action="DoNewDirect.php" enctype="application/x-www-form-urlencoded" metod="post">
<em class='h1'><center>Ввод нового направления</center></em><table border='0' width='100%' cellpadding='0' cellspacing='2'><tr><td height='5' bgcolor="#92a2d9"><img src="../img/line.gif" width=15 height=15 hspace=0 vspace=0 border='0' align='left'></td></tr></table><BR><H2>Заполните форму</H2><br><table  class='ramka' border="0" cellpadding="0" cellspacing="0" align="center">
<tr><td cellpadding="0" cellspacing="0">
<TABLE  class='table' BORDER=0 ALIGN=CENTER CELLSPACING=1 CELLPADDING=1 WIDTH='100%'>
<TR>    <TH><strong>Мин. код</strong></TH>
<TH><strong>Название направления</strong></TH></TR>
<TR>    
<TD align='center'><INPUT TYPE=TEXT NAME='MinKod' SIZE=6 MAXLENGTH=6 onChange="Validator(this)"></INPUT></TD>
<TD align='center'><INPUT TYPE=TEXT NAME='DirectN' MAXLENGTH=150 SIZE=50></INPUT></TD></TR></TABLE></td></tr></table><BR><br><table  class='ramka' border="0" cellpadding="0" cellspacing="0" align="center">
<tr><td cellpadding="0" cellspacing="0">
<TABLE  class='table' BORDER=0 ALIGN=CENTER CELLSPACING=1 CELLPADDING=1 WIDTH='100%'>
<TR>
...
<?php
   ...
   echo ">Вернутся к справочнику направлений &nbsp;&nbsp;</TD>\n";
...
<BR>
<center>
<input type="submit" name="subm" value="Добавить направление в список направлений" />
</center>
</form><BR><hr />
</body></html>