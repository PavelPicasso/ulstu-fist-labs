...
<?php 
    ...
    $dbi_user = "vsbk";
    $dbi_password = "dfnmvfie";
    $Connection=mysql_connect($data_source , $dbi_user , $dbi_password) 
       or die ("Can't connect to $data_source:".mysql_errno().": ".mysql_error()."<BR>");
    mysql_select_db("plans_new") 
       or die("Could not select database:".mysql_errno().": ".mysql_error()."<BR>");
/*    mysql_query("CREATE TABLE blending (
  ...
  PRIMARY KEY  (CodeOfBlend)
    ...
    mysql_query("CREATE TABLE streamblending (
  ...
  PRIMARY KEY  (CodeOfStBl)
    ...
    mysql_query("CREATE TABLE divdiscip (
