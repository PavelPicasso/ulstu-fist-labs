<script type="text/javascript">
    ...
    function loadxml(e) {
        ...
        reader.onloadend = function(file) {
            ...
            var klav = root.getElementsByTagName("Квалификация")[0];
            var kvalName = kval.getAttribute("Название");
            var planName = 'План подготовки ';
            switch (kvalName) {
                case 'bakalavr':
                    planName += 'бакалавров';
                    break;
        ...
        /*var data = [file.name, file.type, file.size, 'Файл не является изображением'];
    ...
    <tr>
        ...
        <td>
            ...
            <table width=90% cellpadding=0 cellspacing=0 border=0 align="center" id="">
                ...
                <tr>
                    <td>
                        Срок обучания (лет) - <span id="years"></span>
                    </td>
                </tr>
            </table>
        </td>
