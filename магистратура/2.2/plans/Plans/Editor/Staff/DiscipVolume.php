...
$sql = "select distinct(p.CodeOfPlan) as cp from schedplan as sh left join plans as p on p.CodeOfPlan=sh.CodeOfPlan where sh.CodeOfDepart=".$_GET['depart']." and (Date is NULL or Date='0000-00-00')";
$res=FetchArrays($sql);
$AddQ = "";
