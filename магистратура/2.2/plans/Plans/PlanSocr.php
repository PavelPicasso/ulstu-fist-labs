...
<TR><TD cellpadding="0" cellspacing="0"  bgcolor="0040A0">
    ...
    <TR>
        <TH class="noname" ROWSPAN="3"  bgcolor="white"><FONT SIZE=-1>Курс</FONT></TH>
        <TH class="noname" ROWSPAN="3"  bgcolor="white" align="center" width="8%"><FONT SIZE=-1>Семестр</FONT></TH>
        <TH class="noname" ROWSPAN="3"  bgcolor="white" align="center"><FONT SIZE=-1>Наименование дисциплины</FONT></TH>
        <TH class="noname" COLSPAN="5"  bgcolor="white" align="center"><FONT SIZE=-1>Учебная нагрузка</FONT></TH>
        <TH class="noname" COLSPAN="2" ROWSPAN="2" bgcolor="white" align="center"><FONT SIZE=-1>Форма отчетности</FONT></TH>
        <TH class="noname" ROWSPAN="3"  bgcolor="white" align="center" width="7%"><FONT SIZE=-1>Кафедра</FONT></TH>
    </TR>
    <TR>
        <TH class="noname" ROWSPAN="2" bgcolor="white" width="4%"><FONT SIZE=-2>Всего</FONT></TH>
        <TH class="noname" COLSPAN="4" bgcolor="white" width="4%"><FONT SIZE=-2>Аудиторная</FONT></TH>
    </TR>
    </TR>
        ...
        <TH class="noname" bgcolor="white" width="4%"><FONT SIZE=-2>Итого аудит.</FONT></TH>
        <TH class="noname" bgcolor="white" width="4%"><FONT SIZE=-2>Курс.пр./ Курс.раб.</FONT></TH>
...
<?php
    ...
    for($i=$FirstYear; $i<$LastYear; $i++){
       $sem1 = 2*$i-1;
       $sem2 = 2*$i;
       $query="SELECT NumbOfSemestr, DisName, AllH, AuditH, LectSem, LabSem, PractSem, LectInW, LabInW, PractInW, KursWork, KursPrj, Test, Exam, Reduction FROM schedplan as sch"
...
//                $pract = $v["PractInW"]*$TSem[$v["NumbOfSemestr"]];
                $all=$lect+$lab+$pract;
//		$all = $v["AuditH"];
                $DisStr .= "<TD bgcolor='white' align='center'><FONT SIZE='-1'>".$v["AllH"]."</FONT></TD>\n";
                ...
                if ($v["KursPrj"]==0&&$v["KursWork"]==0) $tmp = " ";
                if ($v["KursPrj"]!=0&&$v["KursWork"]==0) $tmp = "К.пр.";
                if ($v["KursPrj"]==0&&$v["KursWork"]!=0) $tmp = "К.р.";
                if ($v["KursPrj"]!=0&&$v["KursWork"]!=0) $tmp = "К.пр./ К.р.";
